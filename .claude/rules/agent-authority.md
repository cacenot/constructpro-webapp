...
| UI implementation WITH `{id}-ux-spec.md` present | UI implementation WITHOUT UX spec (see `ux-gate.md`) |

**UX Gate (BLOQUEIO para stories com tela/UI):**

> @dev NUNCA inicia implementação de telas/componentes visuais sem `docs/stories/{epicNum}.{storyNum}-ux-spec.md` produzido por @ux-design-expert. Ver regra completa em `.claude/rules/ux-gate.md`.
