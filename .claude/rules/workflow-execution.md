...
#### Phase 2.5: UX Design (@ux-design-expert) — CONDITIONAL

> **Ativa apenas para stories com tela/UI/componente visual.** Ver critérios em `.claude/rules/ux-gate.md`.

- **Agent:** `@ux-design-expert`
- **Input:** Story validada pelo @po
- **Output:** `docs/stories/{epicNum}.{storyNum}-ux-spec.md`
- **Conteúdo:** Objetivo da tela, fluxo do usuário, estados UI, comportamentos, referências de design
- **Gate:** @dev BLOQUEADO até este artefato existir e estar completo
- **Skip if:** `ux_gate: waived` no arquivo da story (aprovado pelo @po)
