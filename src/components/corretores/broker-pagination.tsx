...
import type { BrokersTablePagination } from '@/hooks/use-brokers-table'

const MAX_VISIBLE_PAGES = 5

export function BrokerPagination({
  page,
  totalPages,
  total,
  pageSize,
  ...
  return (
    <div className="flex flex-col gap-3 border-t px-6 py-4 sm:flex-row sm:items-center sm:justify-between">
      <span className="text-sm text-muted-foreground tabular-nums">
        {total > 0 ? `${startItem}–${endItem} de ${total} corretores` : 'Nenhum corretor'}
      </span>
